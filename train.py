...
from jepa.pipeline import train_stage, write_root_summary
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train a JEPA model from config.")
    ...
    write_root_summary(run_dir, training, None, None)
